...
enum class CustomComponentType {
    EXTRA_SELECT {
        override fun processPrices(cca: CustomComponentAnswer, oe: OrderEntity, ccm: CustomComponentModel, cardType: CardType): Int {
            return ccm.prices.get(cca.selected.get(0))
        }

        override fun processMessage(cca: CustomComponentAnswer, oe: OrderEntity, ccm: CustomComponentModel, cardType: CardType): List<String> {
    ...
    open fun processPrices(cca: CustomComponentAnswer, oe: OrderEntity, ccm: CustomComponentModel, cardType: CardType): Int = 0

    open fun processMessage(cca: CustomComponentAnswer, oe: OrderEntity, ccm: CustomComponentModel, cardType: CardType): List<String> = listOf()
